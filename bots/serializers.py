    ...
    "properties": {
        ...
        "assembly_ai": {
            ...
            "properties": {
                ...
                "speech_models": {"type": "array", "items": {"type": "string", "enum": ["best", "nano", "slam-1", "universal", "universal-2", "universal-3-pro"]}, "uniqueItems": True, "description": "The speech models to use for transcription in order of preference. Defaults to ['universal-3-pro', 'universal-2']. See AssemblyAI docs for details."},
